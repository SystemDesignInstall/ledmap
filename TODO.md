...
- [ ] 7D Serialization: сначала отдельный контракт; production пока не разрешён. Планируемый scope: schema v1 + round-trip + миграции (скелет).
