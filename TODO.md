...
- [ ] 7D production: реализация serialization, tests/fixtures и validation report; ожидает отдельного разрешения после проверки SHA docs-only acceptance-коммита. File I/O и UI Open/Save не входят в этот этап.
